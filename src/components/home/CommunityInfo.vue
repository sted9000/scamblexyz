  ...
  <div class="carousel carousel-center w-full">
    ...
    <div class="carousel-item">
      <div class="carousel-item stats ml-4 bg-gray-100 text-gray-700">
        <div class="stat">
          <div class="stat-title text-gray-700">
            Yesterday's Leaderboard Winner
          </div>
          <div class="stat-value text-info flex items-center">
    ...
    <div class="carousel-item">
      <div class="carousel-item stats ml-4 bg-gray-100 text-gray-700">
        <div class="stat text-info">
          <div class="stat-title text-gray-700">Your Rank</div>
          <div class="stat-value flex items-center">
              <TrophyIcon class="h-8 w-8 mr-2" />
              <div class="stat-value">{{  communityRankFormatting(realtimeStore.getUserRank('Overall')) }}</div>
            </div>
    ...
    <div class="carousel-item">
      <div class="carousel-item stats ml-4 bg-gray-100 text-gray-700">
        <div class="stat">
          <div class="stat-title text-gray-700">Checkins</div>
      ...
      <div class="carousel-item stats ml-4 bg-gray-100 text-gray-700">
        <div className="stat">
          ...
          <div className="stat-value flex items-center text-secondary">
            ...
            <div className="stat-value">{{realtimeStore.getTodaysBonuses}}</div>
          </div>
    ...
    <div class="carousel-item">
      <div class="carousel-item stats ml-4 bg-gray-100 text-gray-700">
        <div class="stat">
          <div class="stat-title text-gray-700">Drops</div>
          <div class="stat-value flex items-center text-accent">
            <EnvelopeOpenIcon class="h-8 w-8 mr-2" />
            <div class="stat-value">{{realtimeStore.getNumberOfDropsToday}}</div>
          </div>
